<script lang="ts">
	const githubLink: string = 'https://github.com/AlexeyBarabash/25th-brave-sync-word';
	const credit: string = 'AlexeyBarabash/25th-brave-sync-word';
</script>
...
<div>
	...
	<a href={githubLink} id="credit">{credit}</a> code, in Svelte.
</div>
